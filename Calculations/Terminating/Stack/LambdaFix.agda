...
-- lambda calculus with a fixed-point combinator is indeed well-defined.

module Calculations.Terminating.Stack.LambdaFix where

open import Calculations.Stack.LambdaFix
